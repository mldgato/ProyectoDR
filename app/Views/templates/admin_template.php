                ...
                <li class="nav-item dropdown user-menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <li class="user-footer">
                            ...
                            <form id="logout-form" action="http://asistencias.test/logout" method="POST" style="display: none;">
                                <input type="hidden" name="_token" value="fRrvYb9yVPbCKhxwS0y3gF3JADFinwLkWmlAEDpp">
                            </form>
                        </li>
                    </ul>
                </li>
